...
import { Smartphone, Store, Info } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 max-w-4xl mx-auto w-full">
        ...
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg text-slate-600 max-w-lg mx-auto">
            ...
            Experience the flow as a Customer or manage orders as a Vendor.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-6 w-full">
          <Link to="/customer" className="group relative overflow-hidden bg-white p-8 rounded-3xl shadow-xl border border-slate-100 hover:shadow-2xl transition-all hover:-translate-y-1">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-500 mb-6">Scan QR, browse menu, and get notified when food is ready.</p>
          ...
          <Link to="/vendor" className="group relative overflow-hidden bg-slate-900 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 mb-6">Manage queue, update status, and track payments in real-time.</p>
              <span className="inline-flex items-center text-orange-400 font-bold group-hover:gap-2 transition-all">
